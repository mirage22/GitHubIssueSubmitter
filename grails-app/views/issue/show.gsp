		...
		<div id="show-issue" class="content scaffold-show" role="main">
			...
			<ol class="property-list issue">
				...
				<li class="fieldcontain">
					<span id="title-label" class="property-label"><g:message code="issue.title.label" default="Title" /></span>
					
						<span class="property-value" aria-labelledby="title-label"><g:fieldValue bean="${issueInstance}" field="title"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${issueInstance?.content}">
				<li class="fieldcontain">
					<span id="content-label" class="property-label"><g:message code="issue.content.label" default="Content" /></span>
					
						<span class="property-value" aria-labelledby="content-label"><g:fieldValue bean="${issueInstance}" field="content"/></span>
